...
void    str_6(char *cstr)
{
	...
	cstr_6[6] = '\0';  // global string array
...
void    str_8(char *cstr)
{
	...
	cstr_8[8] = '\0';  // global string array
...
void    str_16(char *cstr)
{
	...
	cstr_16[16] = '\0';  // global string array
...
// to take an actual short integer (a 16 bit 2s complement
// binary) and convert it into a string of 16 characters of
// 1s and 0s with a NULL byte in the last array position. 
//
// in the functions above we're converting decimal character
// strings to binary character strings, but here we're
// converting a real C short (a true 16 bit 2s complement value) 
// to a corresponding 16 character (1/0 characters) string
...
void	bstr_16(unsigned short bin_num)
{
        ...
        binstr_16[16] = '\0';  // global string array
